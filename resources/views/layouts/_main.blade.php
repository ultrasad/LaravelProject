...
<html>
  <head>
    ...
    <!--
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/pace/pace-theme-flash.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/bootstrap/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/font-awesome/css/font-awesome.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/jquery-scrollbar/jquery.scrollbar.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/bootstrap-select2/select2.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/switchery/css/switchery.min.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/nvd3/nv.d3.min.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/mapplic/css/mapplic.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/rickshaw/rickshaw.min.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/jquery-metrojs/MetroJs.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/switchery/css/switchery.min.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('pages/css/pages-icons.css') }}" />
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('pages/css/pages.css') }}" />
  -->


    {{ Html::style('assets/pace/pace-theme-flash.css') }}
    {{ Html::style('assets/bootstrap/css/bootstrap.min.css') }}
    {{ Html::style('assets/font-awesome/css/font-awesome.css') }}
    {{ Html::style('assets/jquery-scrollbar/jquery.scrollbar.css') }}
    {{ Html::style('assets/bootstrap-select2/select2.css') }}
    {{ Html::style('assets/switchery/css/switchery.min.css') }}
    {{ Html::style('assets/nvd3/nv.d3.min.css') }}
    {{ Html::style('assets/mapplic/css/mapplic.css') }}
    {{ Html::style('assets/rickshaw/rickshaw.min.css') }}
    {{ Html::style('assets/jquery-metrojs/MetroJs.css') }}
    {{ Html::style('assets/switchery/css/switchery.min.css') }}
  ...
  <script src="{{ asset('assets/modernizr.custom.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/jquery-ui/jquery-ui.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/bootstrap/js/bootstrap.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/jquery/jquery-easy.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/jquery-unveil/jquery.unveil.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/jquery-bez/jquery.bez.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/jquery-ios-list/jquery.ioslist.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/jquery-actual/jquery.actual.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/jquery-scrollbar/jquery.scrollbar.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/bootstrap-select2/select2.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/classie/classie.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/switchery/js/switchery.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/nvd3/lib/d3.v3.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/nvd3/nv.d3.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/nvd3/src/utils.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/nvd3/src/tooltip.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/nvd3/src/interactiveLayer.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/nvd3/src/models/axis.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/nvd3/src/models/line.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/nvd3/src/models/lineWithFocusChart.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/mapplic/js/hammer.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/mapplic/js/jquery.mousewheel.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/mapplic/js/mapplic.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/rickshaw/rickshaw.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/jquery-metrojs/MetroJs.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/jquery-sparkline/jquery.sparkline.min.js') }}" type="text/javascript"></script>
