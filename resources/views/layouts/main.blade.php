...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('plugins/pace/pace-theme-flash.css') }}" />
    ...
    {{ Html::style('plugins/mapplic/css/mapplic.css') }}
    {{ Html::style('plugins/rickshaw/rickshaw.min.css') }}
  ...
  {{ Html::script('plugins/nvd3/src/utils.js') }}
  {{ Html::script('plugins/nvd3/src/tooltip.js') }}
  {{ Html::script('plugins/nvd3/src/interactiveLayer.js') }}
  {{ Html::script('plugins/nvd3/src/models/axis.js') }}
  {{ Html::script('plugins/nvd3/src/models/line.js') }}
  {{ Html::script('plugins/nvd3/src/models/lineWithFocusChart.js') }}
  {{ Html::script('plugins/mapplic/js/hammer.js') }}
  {{ Html::script('plugins/mapplic/js/jquery.mousewheel.js') }}
  {{ Html::script('plugins/mapplic/js/mapplic.js') }}
  {{ Html::script('plugins/rickshaw/rickshaw.min.js') }}
