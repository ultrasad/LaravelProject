      ...
      @foreach(menuHelper::brand() as $brand)
        <li class="">
          ...
          @if(isset($brand->category->first()->icon))
            <img src="{{ URL::asset('assets/img/category/icons/'.$brand->category->first()->icon) }}" alt="{{ $brand->name }}" class="category-img" data-src="{{ URL::asset('assets/img/category/icons/'.$brand->category->first()->icon) }}" data-src-retina="{{ URL::asset('assets/img/category/icons/'.$brand->category->first()->icon.'_2x.png') }}" width="20" height="20">-->
          @endif
          </span>
        </li>
      @endforeach
      ...
      @foreach(menuHelper::menu() as $menu)
        <li class="">
          ...
          <span class="icon-thumbnail icon-category {{ Request::is('category/'. $menu->category) ? 'bg-success' : '' }}">
            <img src="{{ URL::asset('assets/img/category/icons/'.$menu->icon) }}" alt="{{ $menu->name }}" class="category-img" data-src="{{ URL::asset('assets/img/category/icons/'.$menu->icon) }}" data-src-retina="{{ URL::asset('assets/img/category/icons/'.$menu->icon.'_2x.png') }}" width="20" height="20">
          </span>
        </li>
      @endforeach
    {{--
