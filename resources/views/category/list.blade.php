                ...
                <div class="item-header clearfix">
                  ...
                  <div class="inline m-l-10">
                    ...
                    @if($category_name != 'unknow')
                        <p class="no-margin hint-text text-master"><a class="category-brand-url" href="{{ URL::to('category', $event->category_first->category) }}" title="{{ $event->category_first->name }}">{{ $event->category_first->name }}</a></p>
                    @else
                        <p class="no-margin hint-text text-master"><a class="category-brand-url" href="{{ URL::to('category', 'unknow') }}" title="Unknow">ไม่ระบุ หมวดหมู่</a></p>
                    @endif
                    --}}
                  </div>
